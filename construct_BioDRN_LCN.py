...
gD = nx.read_gml(directory + 'Orig_NepalDRN_0.gml')
coor = pickle.load(open(data_directory + 'CC_locs.p', 'rb'))
coor.append(pickle.load(open(data_directory + 'PoI_locs.p', 'rb')))
coor.append(pickle.load(open(data_directory + 'Vol_locs.p', 'rb')))
coor.append(pickle.load(open(data_directory + 'S_locs.p', 'rb')))
